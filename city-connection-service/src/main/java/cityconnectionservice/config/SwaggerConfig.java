package cityconnectionservice.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("cityconnectionservice.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Service exposes the departure/arrival time for trips between cities",
                "blank",
                "Terms of service",
